...
:: Use PyTorch 2.7.0 with CUDA 12.8 for all GPUs (universal compatibility)
set PYTORCH_VERSION=2.7.0
set CUDA_VERSION=cu128
echo Using PyTorch 2.7.0 with CUDA 12.8 (universal compatibility)
...
pip install torch==!PYTORCH_VERSION! torchvision torchaudio --index-url https://download.pytorch.org/whl/!CUDA_VERSION!
if errorlevel 1 (
...
:: Try to install SageAttention 2 (40% faster) for PyTorch 2.7.0
...
:: Use Triton 3.3.x for PyTorch 2.7.0 (universal)
...
echo Trying triton-windows 3.3.x for PyTorch 2.7.0...
pip install triton-windows==3.3.1.post19 2>nul || (
...
:: Install compatible Triton for PyTorch 2.7.0
...
:: Try known working versions for PyTorch 2.7.0
pip install triton-windows==3.3.1.post19 2>nul || (
    pip install triton-windows==3.3.0 2>nul || (
        pip install triton-windows==3.2.0.post11 2>nul || (
